...
namespace Akismet.Umbraco.Controllers
{
    ...
    public class AkismetUmbracoApiController : AkismetUmbracoApiControllerBase
    {
        private readonly IBackOfficeSecurityAccessor _backOfficeSecurityAccessor;

        public AkismetUmbracoApiController(IBackOfficeSecurityAccessor backOfficeSecurityAccessor)
        {
