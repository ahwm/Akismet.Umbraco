...
{
    public class AkismetUmbracoApiComposer : IComposer
    {
        public void Compose(IUmbracoBuilder builder)
        {
            ...
            builder.Services.Configure<SwaggerGenOptions>(opt =>
            {
                ...
                {
                    Title = "Akismet Umbraco Backoffice API",
                    Version = "1.0",
                ...
                opt.OperationFilter<AkismetUmbracoOperationSecurityFilter>();
            });
        }

        public class AkismetUmbracoOperationSecurityFilter : BackOfficeSecurityRequirementsOperationFilterBase
        {
        ...
        public class CustomOperationHandler : OperationIdHandler
        {
            ...
            {
                return controllerActionDescriptor.ControllerTypeInfo.Namespace?.StartsWith("Akismet.Umbraco.Controllers", comparisonType: StringComparison.InvariantCultureIgnoreCase) is true;
            }
